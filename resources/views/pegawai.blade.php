...
<head>
    ...
    <title>Data Pegawai - Management System</title>
            ...
            <div class="table-container">
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><strong>{{ $p->pegawai_id }}</strong></td>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="/pegawai/edit/{{ $p->pegawai_id }}" class="btn btn-edit">
                                        <i class="fas fa-edit"></i> Edit
                                    </a>
                                    <a href="/pegawai/hapus/{{ $p->pegawai_id }}" class="btn btn-delete" onclick="return confirm('Yakin ingin menghapus data ini?')">
