...
<body>
    <div class="container">
        <header>
            ...
            <p>Tambahkan karyawan baru ke dalam sistem</p>
        </header>
        ...
        <div class="form-card">
            <div class="form-header">
                <h2 class="form-title">Form Tambah Pegawai</h2>
            ...
            <div class="info-box">
                ...
                <p>Pastikan semua data yang dimasukkan sudah benar dan lengkap sebelum menyimpan.</p>
            </div>
            ...
            <form action="/pegawai/store" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="jabatan" class="form-input" required placeholder="Masukkan jabatan">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="umur" class="form-input" required placeholder="Masukkan umur">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="alamat" class="form-textarea" required placeholder="Masukkan alamat lengkap"></textarea>
                </div>
